...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      {/* Hero */}
      <section data-nav-dark className="relative h-screen flex items-end pb-20 px-8 md:px-16 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?auto=format&fit=crop&w=1920&q=80" alt="Greece" className="absolute inset-0 w-full h-full object-cover" />
