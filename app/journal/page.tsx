...
const articles = [
  {
    ...
    desc: "Filming starts May 2026 across the Greek islands. Santorini, Mykonos and Paros are frontrunners.",
  ...
  },
  {
    ...
    desc: "94 rooms, suites and villas on Kalo Livadi Bay. Cycladic architecture by Nicos Valsamakis.",
  ...
  },
  {
    ...
    desc: "The largest rooms in Athens, Acropolis views, 700m running track, and a Waldorf Astoria Residences wing.",
    href: "https://tornosnews.gr/en/tourism-businesses/hotels/55111-the-high-profile-hotel-openings-expected-in-2026.html",
  ...
  },
  {
    ...
    desc: "41 suites with private pools on Provatas Beach. Volcanic landscape, LEED Gold certified.",
  ...
  },
  {
    ...
    desc: "50 rooms with private pools in Kampos. Paros confirms its rise as the thinking traveler\u2019s alternative to Mykonos.",
  ...
  },
  {
    ...
    desc: "Ancient heritage, modern energy, and a nightlife that rivals any capital in Europe.",
...
export default function Journal() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      ═══════════════════════════════════════════ */}
      <section data-nav-dark className="relative h-[45vh] flex flex-col justify-center items-center text-center overflow-hidden">
      ...
      <section data-nav-dark className="relative h-[50vh] md:h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.3) 40%, rgba(0,0,0,0.1) 100%)" }} />
      ...
      {/* ═══════════════════════════════════════════
          BLOC 3 — ARTICLES GRILLE IMMERSIVE
      ═══════════════════════════════════════════ */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {articles.map((a, i) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="reveal group relative block aspect-[3/4] sm:aspect-[4/5] overflow-hidden cursor-pointer"
                data-delay={i * 60}
              >
                <img
                  src={a.photo}
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 transition-opacity duration-300" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.2) 50%, transparent 100%)" }} />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-300" />

                {/* Pill tag top-left */}
                <span className="absolute top-3 left-3 inline-block px-3 py-1 bg-white/15 backdrop-blur-sm [-webkit-backdrop-filter:blur(4px)] rounded-full font-body text-[10px] font-medium tracking-[0.15em] uppercase text-white">
                  {a.tag}
                </span>

                {/* Text bottom-left */}
                <div className="absolute bottom-0 left-0 right-0 p-5" style={{ textShadow: "0 1px 3px rgba(0,0,0,0.3)" }}>
                  <p className="font-body text-[10px] tracking-[0.1em] uppercase text-white/60">{a.source}</p>
                  <h3 className="font-body text-[15px] md:text-[17px] font-semibold text-white leading-[1.3] mt-2">
                    {a.title}
                  </h3>
                  <p className="font-body text-[13px] text-white/70 font-light leading-[1.5] mt-2 line-clamp-2">
                    {a.desc}
                  </p>
                </div>
              </a>
