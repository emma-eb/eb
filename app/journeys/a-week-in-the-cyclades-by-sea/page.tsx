    ...
    <main className="flex flex-col min-h-screen bg-white">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden group eb-fade-up eb-image-vignette max-w-[1200px] mx-auto">
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10 text-white z-[3] max-w-[600px]">
              <h3 className="font-anton font-normal uppercase text-[26px] md:text-[40px] leading-[1] mb-3">Waking up somewhere new, every morning.</h3>
              <p className="text-[13px] md:text-[15px] opacity-90 leading-[1.5] font-light">One yacht. A chef on board. A route drawn by wind and mood.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section data-nav-dark className="relative w-full h-[80vh] min-h-[500px] overflow-hidden eb-image-vignette">
        ...
        <div className="absolute bottom-12 md:bottom-20 left-6 md:left-16 right-6 md:right-16 max-w-[620px] text-white eb-fade-up z-[3]">
          ...
          <h2 className="font-anton font-normal uppercase text-[36px] md:text-[56px] leading-[0.98] tracking-[0.02em] mb-6">On board.</h2>
          <p className="text-[15px] md:text-[17px] leading-[1.75] opacity-90 font-light">A hand-selected yacht, crewed, with a chef on board. The right vessel matched to your party, confirmed once we know who is sailing.</p>
        </div>
      </section>
      ...
      <section className="bg-white py-10 md:py-14 eb-fade-up">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-3">
            <div className="relative aspect-[4/3] sm:aspect-[3/4] overflow-hidden eb-image-vignette"><Image src="/yatch_page%20collection_2.png" alt="Yacht deck, Cyclades" fill className="object-cover" /></div>
            <div className="relative aspect-[4/3] sm:aspect-[3/4] overflow-hidden eb-image-vignette"><Image src="/alex-azabache-j97YqU81FSw-unsplash%20(1).jpg" alt="Yacht sailing the Aegean" fill className="object-cover" /></div>
            <div className="relative aspect-[4/3] sm:aspect-[3/4] overflow-hidden eb-image-vignette"><Image src="/alexandra-kirr-pV7Cyd4bxkY-unsplash.jpg" alt="Yacht at anchor in a Cycladic bay" fill className="object-cover" /></div>
          </div>
      ...
      <section data-nav-dark className="relative w-full h-[70vh] min-h-[480px] overflow-hidden eb-image-vignette">
        ...
        <div className="relative z-[3] h-full flex items-center justify-center px-8 md:px-10">
          <div className="text-center max-w-[640px] eb-fade-in">
            ...
            <div className="flex justify-center"><Link href="/contact?type=journey&journey=a-week-in-the-cyclades-by-sea" className="bg-white text-[#2e5a88] px-8 py-3.5 rounded-full text-[10px] font-medium tracking-[0.25em] uppercase transition-all hover:scale-[1.03] hover:shadow-xl">Start the conversation &rarr;</Link></div>
          </div>
        </div>
      </section>
