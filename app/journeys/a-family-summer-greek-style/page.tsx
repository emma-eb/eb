  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section data-nav-dark className="relative w-full h-[75vh] md:h-screen md:min-h-[600px] overflow-hidden eb-image-vignette">
        <Image src="/family-journey.webp" alt="Family summer on the Peloponnese coast, Porto Heli" fill priority sizes="100vw" className="object-cover object-center reveal" />
        ...
        <div className="absolute bottom-14 md:bottom-20 left-6 md:left-12 right-6 md:right-12 text-white">
          <div className="bg-white/15 backdrop-blur-sm border border-white/30 rounded-full px-3 py-1 text-[10px] md:text-[11px] tracking-[0.2em] uppercase font-light inline-block mb-6 reveal">Private Journey &middot; 06</div>
          <h1 className="font-anton font-normal uppercase text-[38px] sm:text-[52px] md:text-[68px] leading-[0.95] sm:leading-[0.92] tracking-[0.02em] mb-6 max-w-[92%] md:max-w-[75%] reveal" data-delay="100">
            A Family Summer,<br /> Greek-Style.
          </h1>
          <p className="text-[14px] md:text-[16px] opacity-90 max-w-[480px] leading-[1.55] font-light reveal text-balance" data-delay="200">For eight-year-olds and grandparents, equally.</p>
        </div>
      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="relative h-[60vh] min-h-[400px] md:h-auto md:min-h-0 md:aspect-[21/9] overflow-hidden group reveal eb-image-vignette md:max-w-[1200px] -mx-6 md:mx-auto">
            <Image src="/villa-family-01.webp" alt="Villa pool at sunset, the Peloponnese" fill sizes="100vw" className="object-cover object-center reveal transition-transform duration-700 group-hover:scale-105" />
      ...
      <section data-nav-dark className="relative w-full h-[55vh] min-h-[400px] md:h-[80vh] md:min-h-[500px] overflow-hidden eb-image-vignette">
        <Image src="/damien-schneider-GvOcpTNAHFo-unsplash.webp" alt="Whitewashed villa with arches and pool" fill sizes="100vw" className="object-cover object-center reveal" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/15 to-transparent" />
        <div className="absolute bottom-12 md:bottom-20 left-6 md:left-16 right-6 md:right-16 max-w-[620px] text-white reveal z-[3]">
          ...
          <h2 className="font-anton font-normal uppercase text-[32px] md:text-[56px] leading-[1] md:leading-[0.98] tracking-[0.02em] mb-6">One house,<br />every generation.</h2>
          <p className="text-[14px] md:text-[17px] leading-[1.7] md:leading-[1.75] opacity-90 font-light">A hand-selected villa with a secluded cove, a pool, space for grandparents and teenagers to keep different hours. The right residence matched to your party, confirmed once we know who is traveling.</p>
        </div>
      </section>
      ...
      <section className="bg-white py-10 md:py-14 reveal">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-3">
            <div className="relative aspect-[3/4] overflow-hidden eb-image-vignette group"><Image src="/hydra_02.webp" alt="Hydra port, sailing in" fill className="object-cover reveal" /></div>
            <div className="relative aspect-[3/4] overflow-hidden eb-image-vignette group"><Image src="/hydra_01.webp" alt="Hydra coast and pines, Saronic Gulf" fill className="object-cover reveal" /></div>
            <div className="relative aspect-[3/4] overflow-hidden eb-image-vignette group"><Image src="/hydra_03.webp" alt="Hydra village and rooftops at golden hour" fill className="object-cover reveal" /></div>
          </div>
        </div>
      </section>
      ...
      <section data-nav-dark className="relative w-full h-[70vh] min-h-[480px] overflow-hidden eb-image-vignette">
        ...
        <div className="relative z-[3] h-full flex items-center justify-center px-6 md:px-10">
          <div className="text-center max-w-[640px] reveal">
            ...
            <div className="flex justify-center"><Link href="/contact?type=journey&journey=a-family-summer-greek-style" className="eb-cta-link font-body text-[12px] md:text-[13px] tracking-[0.2em] uppercase text-white min-h-[44px] py-3">Start the conversation <span className="eb-cta-arrow">&rarr;</span></Link></div>
          </div>
        </div>
      </section>
      {/* ============ BACK TO JOURNEYS ============ */}
