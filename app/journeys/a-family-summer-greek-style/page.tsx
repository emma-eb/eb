  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section data-nav-dark className="relative w-full h-[75vh] md:h-screen md:min-h-[600px] overflow-hidden eb-image-vignette">
        <Image src="/familly%20journey.jpg" alt="Family summer on the Peloponnese coast, Porto Heli" fill priority sizes="100vw" className="object-cover object-center eb-image-settle" />
        ...
        <div className="absolute bottom-14 md:bottom-20 left-6 md:left-12 right-6 md:right-12 text-white">
          ...
          <p className="text-[14px] md:text-[16px] opacity-90 max-w-[480px] leading-[1.55] font-light eb-fade-up eb-delay-200 text-balance">For eight-year-olds and grandparents, equally.</p>
        </div>
      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="relative h-[60vh] min-h-[400px] md:h-auto md:min-h-0 md:aspect-[21/9] overflow-hidden group eb-fade-up eb-image-vignette md:max-w-[1200px] -mx-6 md:mx-auto">
            <Image src="/villa%20famill_01.png" alt="Villa pool at sunset, the Peloponnese" fill sizes="100vw" className="object-cover object-center eb-image-settle transition-transform duration-700 group-hover:scale-105" />
      ...
      <section data-nav-dark className="relative w-full h-[55vh] min-h-[400px] md:h-[80vh] md:min-h-[500px] overflow-hidden eb-image-vignette">
        <Image src="/damien-schneider-GvOcpTNAHFo-unsplash.jpg" alt="Whitewashed villa with arches and pool" fill sizes="100vw" className="object-cover object-center eb-image-settle" />
