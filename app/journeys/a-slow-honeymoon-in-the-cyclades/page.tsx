  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section data-nav-dark className="relative w-full h-[75vh] md:h-screen md:min-h-[600px] overflow-hidden eb-image-vignette">
        <Image src="/MILOS_01.webp" alt="Milos coast at golden hour, Cyclades" fill priority sizes="100vw" className="object-cover object-center reveal" />
        ...
        <button type="button" onClick={(e) => (e.currentTarget.closest("section")?.nextElementSibling as HTMLElement)?.scrollIntoView({ behavior: "smooth", block: "start" })} aria-label="Scroll down" className="absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 z-30  cursor-pointer p-2 min-w-[44px] min-h-[44px] flex items-center justify-center">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-white/60 eb-scroll-chevron"><path d="M5 8L10 13L15 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
        </button>
      </section>
          ...
          <div className="relative">
            <div className="hidden md:block">
              <div className="flex items-start justify-between relative">
                ...
                <div className="flex flex-col items-center text-center w-[26%] relative z-10"><div className="w-5 h-5 rounded-full bg-[#2e5a88] border-4 border-white shadow-md mb-6" /><div className="text-[15px] md:text-[17px] tracking-[0.25em] uppercase text-[#2e5a88] font-light mb-2">Milos</div><div className="text-[12px] text-[#1a1a1a]/50 font-light">4 nights &middot; Boutique hotel</div></div>
                <div className="flex flex-col items-center text-center w-[26%] relative z-10"><div className="w-5 h-5 rounded-full bg-[#2e5a88] border-4 border-white shadow-md mb-6" /><div className="text-[15px] md:text-[17px] tracking-[0.25em] uppercase text-[#2e5a88] font-light mb-2">Folegandros</div><div className="text-[12px] text-[#1a1a1a]/50 font-light">3 nights &middot; Boutique hotel</div></div>
      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="relative h-[60vh] min-h-[400px] md:h-auto md:min-h-0 md:aspect-[21/9] overflow-hidden group reveal eb-image-vignette md:max-w-[1200px] -mx-6 md:mx-auto">
            <Image src="/rocher-milos-03.webp" alt="Sarakiniko white rocks and turquoise sea, Milos" fill sizes="100vw" className="object-cover object-center reveal transition-transform duration-700 group-hover:scale-105" />
      ...
      <section data-nav-dark className="relative w-full h-[55vh] min-h-[400px] md:h-[80vh] md:min-h-[500px] overflow-hidden eb-image-vignette">
        <Image src="/milos-sunset.webp" alt="Milos coast at sunset, Aegean" fill sizes="100vw" className="object-cover object-center reveal" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/15 to-transparent" />
      ...
      <section className="bg-white py-10 md:py-14 reveal">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-3">
            <div className="relative aspect-[3/4] overflow-hidden eb-image-vignette group"><Image src="/kimolos.webp" alt="Kimolos village alley, near Milos" fill className="object-cover reveal" /></div>
            <div className="relative aspect-[3/4] overflow-hidden eb-image-vignette group"><Image src="/milos-cave.webp" alt="Sea cave on Milos, Aegean blue" fill className="object-cover reveal" /></div>
            <div className="relative aspect-[3/4] overflow-hidden eb-image-vignette group"><Image src="/milos-maison.webp" alt="Firopotamos, painted fishermen houses on Milos" fill className="object-cover reveal" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-14 md:py-16 px-6 md:px-8 reveal">
        <div className="max-w-[680px] mx-auto text-center">
          ...
          <Link
            href="/contact?type=journey&journey=a-slow-honeymoon-in-the-cyclades"
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
            {[
              ...
              { href: '/journeys/a-week-in-the-cyclades-by-sea', img: '/dean-bennett-7RCjjvfIQ1k-unsplash.webp', category: 'By Sea \u00b7 Private Yacht', title: 'A Week in the Cyclades, by Sea', meta: '7 nights \u00b7 Cyclades by yacht \u00b7 May\u2013September' },
      ...
      <section data-nav-dark className="relative w-full h-[70vh] min-h-[480px] overflow-hidden eb-image-vignette">
        ...
        <div className="relative z-[3] h-full flex items-center justify-center px-6 md:px-10">
          <div className="text-center max-w-[640px] reveal">
            ...
            <div className="flex justify-center"><Link href="/contact?type=journey&journey=a-slow-honeymoon-in-the-cyclades" className="eb-cta-link font-body text-[12px] md:text-[13px] tracking-[0.2em] uppercase text-white min-h-[44px] py-3">Start the conversation <span className="eb-cta-arrow">&rarr;</span></Link></div>
          </div>
        </div>
      </section>
      {/* ============ BACK TO JOURNEYS ============ */}
