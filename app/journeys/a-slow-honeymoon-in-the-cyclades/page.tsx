  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section data-nav-dark className="relative w-full h-screen min-h-[600px] overflow-hidden eb-image-vignette">
        <Image src="/MILOS_01.jpg" alt="Milos coast at golden hour, Cyclades" fill priority sizes="100vw" className="object-cover object-[center_30%] md:object-center eb-image-settle" />
      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="relative h-[100dvh] min-h-[600px] md:h-auto md:min-h-0 md:aspect-[21/9] overflow-hidden group eb-fade-up eb-image-vignette md:max-w-[1200px] -mx-6 md:mx-auto">
            <Image src="/MILOS_02.jpg" alt="Milos turquoise cove and white rocks" fill sizes="100vw" className="object-cover object-[center_35%] md:object-center eb-image-settle transition-transform duration-700 group-hover:scale-105" />
      ...
      <section data-nav-dark className="relative w-full h-[80vh] min-h-[500px] overflow-hidden eb-image-vignette">
        <Image src="/MILOS_03.jpg" alt="A Cycladic villa above the sea" fill className="object-cover eb-image-settle" />
