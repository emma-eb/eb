  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section data-nav-dark className="relative w-full h-screen min-h-[600px] overflow-hidden eb-image-vignette">
        <Image src="/acropole_01.jpg" alt="Parthenon at golden hour, Athens" fill priority sizes="100vw" className="object-cover object-[center_30%] md:object-center eb-image-settle" />
      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="relative h-[100dvh] min-h-[600px] md:h-auto md:min-h-0 md:aspect-[21/9] overflow-hidden group eb-fade-up eb-image-vignette md:max-w-[1200px] -mx-6 md:mx-auto">
            <Image src="https://images.unsplash.com/photo-1630933868840-1e9299a5b8dd?auto=format&fit=crop&w=1600&q=80" alt="Monastiraki Athens with Acropolis in the distance" fill sizes="100vw" className="object-cover object-[center_35%] md:object-center eb-image-settle transition-transform duration-700 group-hover:scale-105" />
