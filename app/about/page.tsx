...
export default function About() {
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="bg-white pt-32 md:pt-44 pb-16 md:pb-24 px-8 md:px-16 border-b border-[#e8e4de]">
        <div className="max-w-5xl">
          <p className="font-body text-xs tracking-[0.3em] uppercase text-[#888] mb-6">About</p>
          <h1 className="font-heading text-6xl md:text-8xl lg:text-[9rem] leading-none text-[#1a1a1a] mb-0">
            Emma<br />Bonnefous
          </h1>
        </div>
      </section>
