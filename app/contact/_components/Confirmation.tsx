  ...
  return (
    <section className="bg-[#fcf7f1] min-h-[calc(100dvh-80px)] flex items-center justify-center px-6 py-20 md:py-28">
      <div className="max-w-[620px] mx-auto text-center">
        ...
        <p className="reveal font-body text-[10px] md:text-[11px] tracking-[0.3em] uppercase text-[#1a1a1a]/40 mb-5">
          Received with thanks
        </p>
        <h1 className="reveal font-body text-[32px] md:text-[48px] text-[#1a1a1a] leading-[1.1] font-normal mb-8" data-delay="80">
          Your brief is with Emma.
        </h1>
        <p className="reveal font-body text-[15px] md:text-[17px] text-[#1a1a1a]/65 leading-[1.7] font-light max-w-[480px] mx-auto mb-8" data-delay="160">
          You will hear back from us within 48 hours. We read every brief ourselves.
        </p>
        {summary && (
          <div className="reveal bg-white border border-[#e8e4de] p-6 md:p-8 text-left mt-6 max-w-[560px] mx-auto" data-delay="220">
        ...
        <p className="reveal font-body text-[13px] md:text-[14px] text-[#1a1a1a]/60 mt-10 italic font-light" data-delay="280">
          &mdash; eb.
        </p>
        <div className="reveal mt-12 md:mt-16" data-delay="340">
          <Link
            href="/"
