...
const inputClass =
  "w-full border-b border-[#e8e4de] bg-transparent py-3 font-body text-[15px] text-[#1a1a1a] placeholder:text-[#ccc] focus:outline-none focus:border-[#1a1a1a] transition-colors";
